cmd_scripts/mod/file2alias.o := ccache gcc -Wp,-MD,scripts/mod/.file2alias.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -Ofast -fno-tree-vectorize -fomit-frame-pointer     -c -o scripts/mod/file2alias.o scripts/mod/file2alias.c
