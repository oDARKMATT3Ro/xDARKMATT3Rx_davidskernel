...
@ arch/arm/kernel/asm-offsets.c -mlittle-endian -mtune=cortex-a15
@ -mcpu=cortex-a15 -marm -mfpu=neon-vfpv4 -mvectorize-with-neon-quad -marm
@ -mabi=aapcs-linux -mno-thumb-interwork -mcpu=cortex-a15 -mtune=cortex-a15
@ -mfloat-abi=soft -mtune=cortex-a7 -mfpu=neon
...
->TSK_STACK_CANARY #312 offsetof(struct task_struct, stack_canary)	@
@ 0 "" 2
